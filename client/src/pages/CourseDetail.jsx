...
export default function CourseDetail() {
  ...
  // Progress simulator (backend-less)
  const calculateProgress = () => {
    ...
    const watched = Math.floor(total * 0.3);
  ...
  if (!course)
    return (
      <div className="min-h-screen bg-white dark:bg-black text-center py-20">
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      <div className="container mx-auto px-4 py-20">
        <button
          onClick={handleBack}
          className="mb-6 inline-flex items-center space-x-2 rounded-full border border-gray-300 px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800"
        >
          <ArrowLeft size={16} />
          <span>Back</span>
        </button>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              {/* Banner */}
              <div className="mb-6 h-64 lg:h-96 overflow-hidden rounded-xl bg-gray-200 dark:bg-gray-900">
                {course.thumbnail ? (
                  <img
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-2">
                      {course.videos.map((v, i) => (
                        <div
                          key={i}
                          className="flex justify-between items-center p-4 rounded-lg bg-gray-50 dark:bg-gray-900 border hover:bg-gray-100 dark:hover:bg-gray-800"
                        >
                          <div className="flex items-center space-x-3">
                            <div className="h-8 w-8 flex items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900">
